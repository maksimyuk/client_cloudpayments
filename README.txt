...
Реализация:
  ...
  * Для настройки Логина и Пароля необходимо установить значения переменных в вирт окружение CLOUD_PAYMENT_API_LOGIN и CLOUD_PAYMENT_API_PASSWORD соответственно.
